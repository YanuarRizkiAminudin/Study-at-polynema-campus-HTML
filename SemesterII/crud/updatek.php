...
<div class="container">
    ...
    <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>" method="post">
        ...
        <div class="form-group">
            <label>No HP:</label>
            <input type="text" name="no_hp" class="form-control" placeholder="Masukan Nama No HP" required/>
        </div>
        <div class="form-group">
            <label>Kelamin :</label>
            <input type="text" name="kelamin" class="form-control" placeholder="Masukan Kelamin" required/>
        </div>
        <div class="form-group">
            <label>Alamat:</label>
